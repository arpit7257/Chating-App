...
//             {/* Sidebar */}
//             <div className={`z-50 h-full bg-gray-100 transition-transform duration-300 ease-in-out ${isSidebarOpen || isLaptop ? 'translate-x-0' : '-translate-x-full'} ${isLaptop ? 'w-64' : 'fixed top-0 left-0 w-64'}`}>
